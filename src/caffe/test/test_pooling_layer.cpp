...
template <typename TypeParam>
class HebbianPoolingLayerTest : public PoolingLayerTest<TypeParam> {
	typedef typename TypeParam::Dtype Dtype;
};


TYPED_TEST_CASE(HebbianPoolingLayerTest, TestDtypesAndDevices);

TYPED_TEST(HebbianPoolingLayerTest, TestSetup) {
	typedef typename TypeParam::Dtype Dtype;
	LayerParameter layer_param;
	PoolingParameter* pooling_param = layer_param.mutable_pooling_param();
	pooling_param->set_kernel_size(3);
	pooling_param->set_stride(2);
	HebbianPoolingLayer<Dtype> layer(layer_param);
	layer.SetUp(this->blob_bottom_vec_, this->blob_top_vec_);
	EXPECT_EQ(this->blob_top_->num(), this->blob_bottom_->num());
	EXPECT_EQ(this->blob_top_->channels(), this->blob_bottom_->channels());
	EXPECT_EQ(this->blob_top_->height(), 3);
...
TYPED_TEST(HebbianPoolingLayerTest, TestSetupPadded) {
	typedef typename TypeParam::Dtype Dtype;
	LayerParameter layer_param;
	PoolingParameter* pooling_param = layer_param.mutable_pooling_param();
	pooling_param->set_kernel_size(3);
...
TYPED_TEST(HebbianPoolingLayerTest, TestSetupGlobalPooling) {
	typedef typename TypeParam::Dtype Dtype;
	LayerParameter layer_param;
	PoolingParameter* pooling_param = layer_param.mutable_pooling_param();
	pooling_param->set_global_pooling(true);
...
/*
TYPED_TEST(HebbianPoolingLayerTest, PrintBackward) {
LayerParameter layer_param;
layer_param.set_kernelsize(3);
layer_param.set_stride(2);
layer_param.set_pool(LayerParameter_PoolMethod_MAX);
...
TYPED_TEST(HebbianPoolingLayerTest, TestForwardMax) {
	this->TestForwardSquare();
	this->TestForwardRectHigh();
	this->TestForwardRectWide();
}

TYPED_TEST(HebbianPoolingLayerTest, TestForwardMaxTopMask) {
	this->blob_top_vec_.push_back(this->blob_top_mask_);
	this->TestForwardSquare();
	this->TestForwardRectHigh();
	this->TestForwardRectWide();
...
//TYPED_TEST(HebbianPoolingLayerTest, TestGradientMax) {
//	typedef typename TypeParam::Dtype Dtype;
//	for (int kernel_h = 3; kernel_h <= 4; kernel_h++) {
//		for (int kernel_w = 3; kernel_w <= 4; kernel_w++) {
//			LayerParameter layer_param;
...
TYPED_TEST(HebbianPoolingLayerTest, TestForwardMaxPadded) {
	typedef typename TypeParam::Dtype Dtype;
	LayerParameter layer_param;
	PoolingParameter* pooling_param = layer_param.mutable_pooling_param();
	pooling_param->set_kernel_size(3);
...
//TYPED_TEST(HebbianPoolingLayerTest, TestGradientMaxTopMask) {
//	typedef typename TypeParam::Dtype Dtype;
//	for (int kernel_h = 3; kernel_h <= 4; kernel_h++) {
//		for (int kernel_w = 3; kernel_w <= 4; kernel_w++) {
//			LayerParameter layer_param;
...
TYPED_TEST(HebbianPoolingLayerTest, TestForwardAve) {
	typedef typename TypeParam::Dtype Dtype;
	LayerParameter layer_param;
	PoolingParameter* pooling_param = layer_param.mutable_pooling_param();
	pooling_param->set_kernel_size(3);
...
//TYPED_TEST(HebbianPoolingLayerTest, TestGradientAve) {
//	typedef typename TypeParam::Dtype Dtype;
//	for (int kernel_h = 3; kernel_h <= 4; kernel_h++) {
//		for (int kernel_w = 3; kernel_w <= 4; kernel_w++) {
//			LayerParameter layer_param;
...
//}
//
//TYPED_TEST(HebbianPoolingLayerTest, TestGradientAvePadded) {
//	typedef typename TypeParam::Dtype Dtype;
//	for (int kernel_h = 3; kernel_h <= 4; kernel_h++) {
//		for (int kernel_w = 3; kernel_w <= 4; kernel_w++) {
//			LayerParameter layer_param;
